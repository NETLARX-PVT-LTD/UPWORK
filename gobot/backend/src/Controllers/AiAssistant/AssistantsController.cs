...
namespace Netlarx.Products.Gobot.Controllers.AiAssistant
{
    ...
    public class AssistantsController : ControllerBase
    {
        ...
        public async Task<AssistantActionResult> CreateAssistantAsync([FromForm] AiAssistantBlockRequest request)
        {
        ...
        public async Task<AssistantActionResult> UpdateAssistantByAssistantIdAsync(Guid assistantId, [FromForm] AiAssistantBlockRequest request)
        {
            var errors = new Errors();
        ...
        [HttpPost("UploadFilesByAssistantId/{assistantId}")]
        public async Task<AssistantActionResult> UploadFilesByAssistantIdAsync(Guid assistantId, [FromForm] IFormFileCollection files)
        {
            var errors = new Errors();
        ...
        [HttpPost("AddWebsiteSourcesByAssistantId/{assistantId}")]
        public async Task<AssistantWebSiteResult> AddWebsiteSourcesByAssistantIdAsync(Guid assistantId, [FromBody] AiAssistantWebsiteRequest webSiteData)
        {
            var errors = new Errors();
