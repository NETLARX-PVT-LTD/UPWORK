...
namespace Netlarx.Products.Gobot.Controllers.LinkStories
{
    ...
    public class LinkStoryController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<IActionResult> GetLinkStories(int botId)
        {
        ...
        public async Task<IActionResult> AddLinkStory(int botId, [FromBody] LinkStoryBlock linkStoryDto)
        {
            // Try to find the bot
        ...
        [HttpPut("{linkStoryId}")]
        public async Task<IActionResult> UpdateLinkStory(int botId, Guid linkStoryId, [FromBody] LinkStoryBlock updateRequest)
        {
        ...
        public async Task<IActionResult> DeleteLinkStory(int botId, Guid linkId)
        {
            var linkStory = await _context.LinkStory
